...
# Slide 8: DETAILED COMPETITOR PRICING GRID
...
tf.word_wrap = True
p = tf.paragraphs[0]
p.text = "Note: 1-800 Bollards pricing verified. Grainger 4\" CS: $701. U-Line 4.5\" removable: $120-125. Ideal Shield, Post Guard, Global Industrial, Bollard Barrier, and Reliance Foundry require quotes."
p.font.size = Pt(9)
p.font.italic = True
p.font.color.rgb = GRAY
