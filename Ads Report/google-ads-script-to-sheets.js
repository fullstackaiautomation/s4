 ...
 * 5. Replace SPREADSHEET_URL below with your Google Sheet URL
 * 6. Click "Preview" to test
 * 7. Click "Run" or schedule it to run monthly
 */

// ====== CONFIGURATION ======
const SPREADSHEET_URL = 'YOUR_GOOGLE_SHEET_URL_HERE';
const SHEET_NAME = 'Google Ads Data';
...
function main() {
  ...
  try {
    ...
    // Clear existing data (keep first row for manual notes if needed)
    sheet.clear();
...
/**
 * OPTIONAL: Schedule this function to run automatically
 * Go to Scripts → Select this script → Click "Run frequency"
 * Set to: Monthly, on the 1st day, at a time of your choice
 */
